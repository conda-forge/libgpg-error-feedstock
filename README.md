...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libgpg-error-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libgpg-error-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libgpg-error
# for installing globally
pixi global install libgpg-error
```
...
It is possible to list all of the versions of `libgpg-error` available on your platform:
...
```
pixi search libgpg-error --channel conda-forge
```
